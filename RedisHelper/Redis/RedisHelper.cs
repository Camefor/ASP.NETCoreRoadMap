...
namespace TPLConsole.Redis
{
    public class RedisHelper : IRedisHelper
    {
        ...
        //public async Task<bool> StringSetAsync<T>(string key, T value,int seconds) =>
        //  await _db.StringSetAsync(key, value.ToRedisValue(),TimeSpan.FromSeconds(seconds));
